...
class TestVOApi():
    ...
    def test_1_find_empty_list(self):

        """ VO (API): Check list of VOs is empty at outset """    
        print '1'

    def test_2_add_vo_failure(self):
        print '2'
    
    def test_3_add_vo_success(self):
        print '3'

    def test_4_find_one_entry_in_list(self):
        print '4'

    def test_5_add_duplicate_vo_failure(self):
        print '5'

    def test_6_add_second_vo_success(self):
        print '6'

    def test_7_find_two_entries_in_list(self):
        print '7'
